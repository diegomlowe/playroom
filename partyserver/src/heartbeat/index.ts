...
import { validateAdminAuth } from '../lib/wallet-auth.js';

// Import your task handlers here:
// import { cleanup } from './cleanup.js';
// import { syncLeaderboard } from './sync-leaderboard.js';
import { autoCancelStaleMatches } from './auto-cancel-stale-matches.js';
import { distributeFeePool } from './distribute-fee-pool.js';
import { resolveCoinflipMatches } from './resolve-coinflip-matches.js';
...
const handlers: Record<string, () => Promise<void>> = {
  ...
  'auto-cancel-stale-matches': autoCancelStaleMatches,
  'distribute-fee-pool': distributeFeePool,
  'resolve-coinflip-matches': resolveCoinflipMatches,
};
